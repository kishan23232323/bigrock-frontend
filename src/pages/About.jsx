          ...
          <div className={`${styles.featureCard} bg-gray-900/50 backdrop-blur-md border border-gray-700 rounded-2xl p-6 md:p-8`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg text-cyan-300 mb-2">One Place for Many Chains and Tokens</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg text-cyan-300 mb-2">P2P You’ll Actually Want to Use</h3>
                  <p className={`${styles.cardText} text-gray-400 leading-relaxed text-justify`}>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg text-cyan-300 mb-2">Earn While You Participate</h3>
                  <p className={`${styles.cardText} text-gray-400 leading-relaxed text-justify`}>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg text-cyan-300 mb-2">True Non-Custodial Security</h3>
                  <p className={`${styles.cardText} text-gray-400 leading-relaxed text-justify`}>
